...
<?php
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center"
        <?php if($tipo == "colaborador") : ?>href="IndexColaborador.php"
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="PerfilView.php">
            <i class="fas fa-fw fa-table"></i><span>Perfil</span></a>
        <?php elseif($tipo == "administrador") : ?>
        <a class="nav-link" href="ColaboradoresView.php">
            <i class="fas fa-fw fa-tachometer-alt"></i><span>Usúarios</span>
        </a>
        <?php endif; ?>
    </li>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" name="sair">Logout</button>
                    </div>
                </div>
            </div>
        </div>
